  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link" href="proses.php">Pendaftaran</a>
      </div>
    </div>
  </div>
</nav>
    <div class="container mt-4">
        <h2>Data Siswa</h2><br>
        <a class="btn btn-primary" href="kelola.php" role="button">Kelola</a>
        <br><br>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                while($siswa = mysqli_fetch_array($query)) {
                    ...
                    <a href='kelola.php?edit=" . $siswa['id'] . "' class='btn btn-primary'>Edit</a>
                    <a href='proses.php?hapus=" . $siswa['id'] . "' class='btn btn-info'>Delete</a>
                          </td>";
                    echo "</tr>";
                }
                ?>
